...
public class SMSToggleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_toggle_action_sms,container,false);

        String togglesConfigId = MainActivity.sharedPreferences.getString(MainActivity.WHATSAPP_TOGGLES,"");
        cargar = view.findViewById(R.id.btnSMSLoad);
        placinToggles = view.findViewById(R.id.placing_sms_toggles);
        btnToAddVolDown = view.findViewById(R.id.smsVolDowm);
        btnToAddVolUp = view.findViewById(R.id.smsVolUp);
        guardar = view.findViewById(R.id.SMSGuardar);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.editor.putString(MainActivity.SMS_TOGGLES, String.valueOf(togglesIdBuilder));
