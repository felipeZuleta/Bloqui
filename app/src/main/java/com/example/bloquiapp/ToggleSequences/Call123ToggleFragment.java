...
public class Call123ToggleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_toggle_action_123,container,false);

        String togglesConfigId = MainActivity.sharedPreferences.getString(MainActivity.CALL123_TOGGLES,"");
        cargar = view.findViewById(R.id.btnCall123Load);
        placinToggles = view.findViewById(R.id.placing_123_toggles);
        btnToAddVolDown = view.findViewById(R.id.p123VolDowm);
        btnToAddVolUp = view.findViewById(R.id.p123VolUp);
        guardar = view.findViewById(R.id.Call123Guardar);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.editor.putString(MainActivity.CALL123_TOGGLES, String.valueOf(togglesIdBuilder));
