...
public class WhatsAppToggleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_toggle_action_whatsapp,container,false);

        String togglesConfigId = MainActivity.sharedPreferences.getString(MainActivity.WHATSAPP_TOGGLES,"");
        cargar = view.findViewById(R.id.btnWppLoad);
        placinToggles = view.findViewById(R.id.placing_whatsapp_toggles);
        btnToAddVolDown = view.findViewById(R.id.whatsappVolDowm);
        btnToAddVolUp = view.findViewById(R.id.whatsappVolUp);
        guardar = view.findViewById(R.id.wppGuardar);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.editor.putString(MainActivity.WHATSAPP_TOGGLES, String.valueOf(togglesIdBuilder));
