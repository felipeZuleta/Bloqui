...
public class PoliceToggleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_toggle_action_police,container,false);

        String togglesConfigId = MainActivity.sharedPreferences.getString(MainActivity.POLICE_TOGGLES,"");
        cargar = view.findViewById(R.id.btnWppLoad);
        placinToggles = view.findViewById(R.id.placing_police_toggles);
        btnToAddVolDown = view.findViewById(R.id.policeVolDowm);
        btnToAddVolUp = view.findViewById(R.id.policeVolUp);
        guardar = view.findViewById(R.id.PolGuardar);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.editor.putString(MainActivity.POLICE_TOGGLES, String.valueOf(togglesIdBuilder));
