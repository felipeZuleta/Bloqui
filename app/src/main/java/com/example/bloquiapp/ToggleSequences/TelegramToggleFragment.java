...
public class TelegramToggleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_toggle_action_telegram,container,false);

        String togglesConfigId = MainActivity.sharedPreferences.getString(MainActivity.TELEGRAM_TOGGLES,"");
        cargar = view.findViewById(R.id.btnTelLoad);
        placinToggles = view.findViewById(R.id.placing_telegram_toggles);
        btnToAddVolDown = view.findViewById(R.id.telegramVolDowm);
        btnToAddVolUp = view.findViewById(R.id.telegramVolUp);
        guardar = view.findViewById(R.id.telgramGuardar);
        if (!togglesConfigId.equals("") && !viewLoaded){
            ...
            guardar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MainActivity.editor.putString(MainActivity.TELEGRAM_TOGGLES, String.valueOf(togglesIdBuilder));
                    MainActivity.editor.apply();
                    System.out.println(MainActivity.sharedPreferences.getString(MainActivity.TELEGRAM_TOGGLES, ""));
